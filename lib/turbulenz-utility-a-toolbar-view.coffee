...
class TurbulenzUtilityAToolBarView extends View
  ...
  @content: ->
    ...
    @div class: 'panel-heading padded heading header-view', => #header
      ...
      @button class: "btn #{css}", click: 'trigger_filecompile', 'Assets'
      #@label 'Assets:'

      @label '| Scripts:'

      @span class: 'heading-status icon-gear', outlet: '', click: ''
      @button class: "btn #{css}", click: 'trigger_maincompile', 'Compile Main'
      #@label 'Build'
      #@span class: 'heading-status icon-code', outlet: '', click: ''
      @button class: "btn #{css}", click: 'trigger_filecompile', 'Compile File Editor'
      #@label ' File'
